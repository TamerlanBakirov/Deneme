...
export default function DentArtFogszatDebrecenWebsite() {
    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="pt-40 pb-24 text-center text-white"
        ...
        <div className="max-w-3xl mx-auto px-6">
          <h1 className="text-5xl font-extrabold mb-6">Üdvözöljük a Dent-Art Fogászat Debrecen oldalán</h1>
          <p className="text-xl opacity-90 mb-8">
            Megbízható dentist szolgáltatások Debrecen szívében.
          </p>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Debrecen, Bethlen u. 11</p>
                </div>
              </div>
              <div className="flex gap-4">
                <span className="text-2xl">&#128222;</span>
                <div>
                  ...
                  <p className="text-gray-600">+36 52 567 890</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 text-center">
        <p className="text-gray-400">&copy; 2026 Dent-Art Fogászat Debrecen. Minden jog fenntartva.</p>
      </footer>
    </div>
  );
}
