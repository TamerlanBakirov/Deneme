...
export default function KisPipatteremWebsite() {
    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="pt-40 pb-24 text-center text-white"
        ...
        <div className="max-w-3xl mx-auto px-6">
          <h1 className="text-5xl font-extrabold mb-6">Üdvözöljük a Kis Pipa Étterem oldalán</h1>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Budapest, Akácfa u. 38</p>
                </div>
              </div>
              <div className="flex gap-4">
                <span className="text-2xl">&#128222;</span>
      ...
      <footer className="bg-gray-900 text-white py-12 text-center">
        <p className="text-gray-400">&copy; 2026 Kis Pipa Étterem. Minden jog fenntartva.</p>
      </footer>
    </div>
  );
}
