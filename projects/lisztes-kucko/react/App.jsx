...
export default function LisztesKuckWebsite() {
    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="pt-40 pb-24 text-center text-white"
        ...
        <div className="max-w-3xl mx-auto px-6">
          <h1 className="text-5xl font-extrabold mb-6">Üdvözöljük a Lisztes Kuckó oldalán</h1>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Debrecen, Csapó u. 30</p>
                </div>
              </div>
              <div className="flex gap-4">
                <span className="text-2xl">&#128222;</span>
                <div>
                  ...
                  <p className="text-gray-600">+36 30 456 7892</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 text-center">
        <p className="text-gray-400">&copy; 2026 Lisztes Kuckó. Minden jog fenntartva.</p>
      </footer>
    </div>
  );
}
